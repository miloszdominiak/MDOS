...
myos: out/kernel.o out/terminal.o out/boot.o out/ports.o out/string.o out/pci.o out/stdio.o out/stdlib.o out/uhci.o out/ehci.o out/xhci.o out/acpi.o out/asmterm.o out/ps2.o out/interrupts.o
	...
	qemu-system-i386 -cdrom out/myos.iso -usb -device usb-ehci -device qemu-xhci -d int,cpu_reset,pcall -device edu
