...
myos: out/kernel.o out/terminal.o out/boot.o out/ports.o out/string.o out/pci.o out/stdio.o out/stdlib.o out/uhci.o out/ehci.o out/xhci.o out/acpi.o out/asmterm.o
